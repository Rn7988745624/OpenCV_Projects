...
while True:
    ...
    for x, y, w, h in face_coordinates:
        ...
        eye_coordinates = train_eye_data.detectMultiScale(face_grey_img, scaleFactor=1.1, minNeighbors=10)
        smile_coordinates = train_smile_data.detectMultiScale(face_grey_img, scaleFactor=1.7, minNeighbors=25)
